...
/**
 * A simple JPanel extension that adds translucency support. This component and all of its content will be displayed
 * with the specified &quot;alpha&quot; transluscency property value. It also supports the Painters using the
 * backgroundPainter property. For example, to change the background of the panel to a checkeboard do something like
 * this:
 *
 *
 * <PRE>
 *  <CODE>JXPanel panel = new JXPanel();
 * panel.setBackgroundPainter(new CheckerboardPainter());</CODE>
 * </PRE>
 * 
 * @author rbair
 * 
 *         Note: This has been imported directly into the SwingSet3 source in order to make a critical bugfix which was
 *         needed for SwingSet3.
 */
public class JXPanel extends JPanel implements Scrollable {
	...
	/**
	 * If the old alpha value was 1.0, I keep track of the opaque setting because a translucent component is not opaque,
	 * but I want to be able to restore opacity to its default setting if the alpha is 1.0. Honestly, I don't know if
	 * this is necessary or not, but it sounded good on paper :)
	 * <p>
	...
	/**
	 * @return the alpha translucency level for this component. This will be a value between 0 and 1, inclusive.
	 */
